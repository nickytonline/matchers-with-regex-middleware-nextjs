...
const server_1 = __webpack_require__(301);
const response_1 = __webpack_require__(999);
/**
...
/* harmony import */ var _netlify_next__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(531);
/* harmony import */ var _netlify_next__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_netlify_next__WEBPACK_IMPORTED_MODULE_1__);


async function middleware(req) {
    const { pathname  } = req.nextUrl;
    const request = new _netlify_next__WEBPACK_IMPORTED_MODULE_1__.MiddlewareRequest(req);
    const res = await request.next();
    if (pathname.startsWith("/shows/7")) {
        res.headers.set("x-show", "7");
    }
    if (pathname.startsWith("/shows/4")) {
        res.headers.set("x-show", "4");
    }
    // Shouldn't match
...
('__import_unsupported' in globalThis)||    Object.defineProperty(globalThis, "__import_unsupported", {
